...
class CurrencyExchangeTest < Test::Unit::TestCase
  ...
  def test_non_base_currency_exchange_is_correct
    ...
    assert_equal correct_rate, CurrencyExchange.rate(Date.new(2018,11,22), "GBP", "USD", "../data/exrates.json")
  end

  def test_base_currency_exchange_is_correct
    correct_rate = 0.007763975155279502
    assert_equal correct_rate, CurrencyExchange.rate(Date.new(2018,11,22), "JPY", "EUR", "../data/exrates.json")
  end
end
